...
const ArticleCardSkeleton = ({className}) => {
  return (
    <div
    className={`${className} rounded-xl overflow-hidden shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] lg:w-[calc(33.33%-20px)] animate-pulse`}
  >
    {/* image */}
...
{/* profile image */}
          ...
          <div className="flex flex-col items-center">
            ...
            {/* verification status */}
            <div className="w-16 h-2 mt-4 rounded-lg bg-slate-300"/>
